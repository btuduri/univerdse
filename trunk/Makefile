...
ifeq ($(strip $(ARM7_SELECTED)), ARM7_BASIC)
	LIBS	:= -lNE -lfat -lnds9 -ldswifi9
endif
ifeq ($(strip $(ARM7_SELECTED)), ARM7_MOD_DSWIFI)
	LIBS	:= -lNE -lfat -lnds9 -ldswifi9
endif
ifeq ($(strip $(ARM7_SELECTED)), ARM7_MOD_LIBLOBBY)
	LIBS	:= -lNE  -lfat -lnds9 -llobby9d
endif
ifeq ($(strip $(ARM7_SELECTED)), ARM7_MP3)
	LIBS	:= -lNE -lfat -lnds9
endif
...
ifeq ($(strip $(ARM7_SELECTED)), ARM7_MIKMOD_DSWIFI)
	LIBS	:= -lNE -lfat -lnds9 -ldswifi9 -lmikmod9
endif
...
#---------------------------------------------------------------------------------
ifeq ($(strip $(ARM7_SELECTED)), ARM7_BASIC)
	LIBDIRS	:=	$(DEVKITPRO)/libnds $(DEVKITPRO)/nitroengine
endif
ifeq ($(strip $(ARM7_SELECTED)), ARM7_MOD_DSWIFI)
	LIBDIRS	:=	$(DEVKITPRO)/libnds $(DEVKITPRO)/nitroengine
endif
ifeq ($(strip $(ARM7_SELECTED)), ARM7_MOD_LIBLOBBY)
	LIBDIRS	:=	$(DEVKITPRO)/libnds $(DEVKITPRO)/liblobby $(DEVKITPRO)/nitroengine
endif
ifeq ($(strip $(ARM7_SELECTED)), ARM7_MP3)
	LIBDIRS	:=	$(DEVKITPRO)/libnds $(DEVKITPRO)/nitroengine
endif
...
ifeq ($(strip $(ARM7_SELECTED)), ARM7_MIKMOD_DSWIFI)
	LIBDIRS	:=	$(DEVKITPRO)/libnds $(DEVKITPRO)/mikmod $(DEVKITPRO)/nitroengine
endif
